...
<div class="h-screen flex overflow-hidden bg-white">
  ...
  <div class="hidden lg:flex lg:flex-shrink-0">
    ...
    <div class="flex flex-col min-w-0 flex-1 overflow-hidden">
        ...
        <div class="flex-1 relative z-0 flex overflow-y-auto bg-gray-50">
            <main class="flex-1 relative z-0 focus:outline-none h-full" tabindex="0">
                <!-- Start main area-->
...
{{--                </div>--}}
            ...
            @if(isset($aside))
                <aside class="hidden relative xl:flex xl:flex-col flex-shrink-0 w-96">
                    <div class="absolute inset-0 py-6 px-4 sm:px-6 lg:pr-8">
                        {{ $aside }}
                    </div>
                </aside>
            @endif
