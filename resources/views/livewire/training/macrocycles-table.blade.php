    ...
    <x-card.basic>
        <div class="flex-col">
            <div class="flex justify-between items-center mb-4">
                <header class="py-2 text-xl text-gray-600 italic">Current Training Cycles</header>
                                        ...
                                        <div class="flex w-full w-11/12">
                                            <div class="flex flex-col w-full">
                                                <div class="flex w-full">
                                                    ...
                                                    <div
                                                        class="w-2/12 text-center">{{ $macrocycle->number_of_weeks }}</div>
                                                    <div
                                                        class="w-2/12 text-center">{{ $macrocycle->number_of_mesocycles }}</div>
